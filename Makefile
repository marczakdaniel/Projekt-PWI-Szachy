...
szachy: main.o structure.o gamerules.o front.o
	gcc -std=c11 -Wall -Wextra -Werror main.o structure.o gamerules.o front.o -o szachy -lncurses
...
structure.o: source/structure.c source/structure.h source/gamerules.h
	gcc -std=c11 -Wall -Wextra -Werror -c source/structure.c -o structure.o
